...
public class Enemy : MonoBehaviour
{
    ...
    private void MoveUp()
    {
        //rig.velocity = _speed * Time.deltaTime * Vector2.up;
    ...
    {
        //rig.velocity = _speed * Time.deltaTime * Vector2.down;
        transform.Translate(_speed * Time.deltaTime * Vector2.down);
    }

    void MoveLeft()
    {
        //rig.velocity = _speed * Time.deltaTime * Vector2.left;
        transform.Translate(_speed * Time.deltaTime * Vector2.left);
    }

    private void MoveRight()
    {
        //rig.velocity = _speed * Time.deltaTime * Vector2.right;
